...
MultiEffectDelayAudioProcessorEditor::MultiEffectDelayAudioProcessorEditor(MultiEffectDelayAudioProcessor& p)
...
MultiEffectDelayAudioProcessorEditor::~MultiEffectDelayAudioProcessorEditor()
{
}

//==============================================================================

void MultiEffectDelayAudioProcessorEditor::paint(Graphics& g)
{
	g.fillAll(getLookAndFeel().findColour(ResizableWindow::backgroundColourId));
}

void MultiEffectDelayAudioProcessorEditor::resized()
{
